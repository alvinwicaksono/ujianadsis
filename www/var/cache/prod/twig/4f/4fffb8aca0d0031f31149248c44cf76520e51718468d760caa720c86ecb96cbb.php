...
class __TwigTemplate_ea34052be47dcd0f48daf65c3b5f3e3b40cc0577b00e43db65ba23cea95720fb extends Twig_Template
{
  ...
  orderingurl=\"";
        // line 30
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_product_catalog", array("offset" => 0, "limit" => 300, "orderBy" => "position_ordering", "sortOrder" => (isset($context["sortOrder"]) ? $context["sortOrder"] : null))), "html", null, true);
        echo "\"
  newproducturl=\"";
        // line 31
